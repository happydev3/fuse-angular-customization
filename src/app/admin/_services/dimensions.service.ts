...
export class DimensionsService implements Resolve<any> {
...
export class BoardResolve implements Resolve<any>
{
     ...
     */
    constructor(
        private _dimensionsService: DimensionsService
    )
    {
    }
    ...
    {
        return this._dimensionsService.getBoard(route.paramMap.get('boardId'));
    }
}
